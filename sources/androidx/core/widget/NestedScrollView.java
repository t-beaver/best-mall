...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, SJISContextAnalysis.HIRAGANA_HIGHBYTE);
            if (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(SJISContextAnalysis.HIRAGANA_HIGHBYTE)) {
                return false;
            }
            return true;
