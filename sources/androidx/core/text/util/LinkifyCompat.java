...
public final class LinkifyCompat {
    ...
    public static boolean addLinks(Spannable spannable, int i) {
        ...
        if ((i & 1) != 0) {
            gatherLinks(arrayList, spannable, PatternsCompat.AUTOLINK_WEB_URL, new String[]{DeviceInfo.HTTP_PROTOCOL, DeviceInfo.HTTPS_PROTOCOL, "rtsp://"}, Linkify.sUrlMatchFilter, (Linkify.TransformFilter) null);
        }
        if ((i & 2) != 0) {
