...
public abstract class VersionedParcel {
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + readString + Operators.BRACKET_END_STR, e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + readString + Operators.BRACKET_END_STR, e2);
        }
    }
