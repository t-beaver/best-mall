                ...
                if (matcher2.lookingAt()) {
                    ...
                    if (group2 != null && group2.equalsIgnoreCase("charset")) {
                        ...
                        if (str2 == null || group3.equalsIgnoreCase(str2)) {
                            ...
                            throw new IllegalArgumentException("Multiple charsets defined: \"" + str2 + "\" and: \"" + group3 + "\" for: \"" + str + Operators.QUOTE);
                        }
                    }
                    end = matcher2.end();
                } else {
                    throw new IllegalArgumentException("Parameter is not formatted correctly: \"" + str.substring(end) + "\" for: \"" + str + Operators.QUOTE);
                }
            }
