    ...
    public static final class Builder {
        ...
        private void resolvePath(java.lang.String r11, int r12, int r13) {
            ...
            L_0x002a:
                ...
                int r12 = dc.squareup.okhttp3.internal.Util.delimiterOffset((java.lang.String) r11, (int) r6, (int) r13, (java.lang.String) r12)
            ...
            L_0x0043:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.HttpUrl.Builder.resolvePath(java.lang.String, int, int):void");
        }
        ...
        public Builder parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                ...
                if (i42 < i32) {
                    ...
                    this.port = parsePort;
                    if (parsePort == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str2.substring(i42, i32) + Operators.QUOTE);
                    }
                } else {
                    this.host = canonicalizeHost(str2, i2, portColonOffset2);
                ...
                if (this.host != null) {
                    ...
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i2, portColonOffset2) + Operators.QUOTE);
                }
            } else {
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!buffer2.exhausted()) {
                        byte readByte = buffer2.readByte() & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
                        buffer.writeByte(37);
