...
class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            return new JdkWithJettyBootPlatform(method, cls.getMethod("get", new Class[]{SSLSocket.class}), cls.getMethod(AbsoluteConst.XML_REMOVE, new Class[]{SSLSocket.class}), cls3, cls4);
