...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectTls(dc.squareup.okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            r7 = this;
            dc.squareup.okhttp3.Route r0 = r7.route
            dc.squareup.okhttp3.Address r0 = r0.address()
            javax.net.ssl.SSLSocketFactory r1 = r0.sslSocketFactory()
            r2 = 0
            java.net.Socket r3 = r7.rawSocket     // Catch:{ AssertionError -> 0x012e }
            dc.squareup.okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x012e }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x012e }
            dc.squareup.okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x012e }
            ...
            dc.squareup.okhttp3.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            if (r3 == 0) goto L_0x0041
            dc.squareup.okhttp3.internal.platform.Platform r3 = dc.squareup.okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            dc.squareup.okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
        ...
        L_0x0041:
            ...
            dc.squareup.okhttp3.Handshake r4 = dc.squareup.okhttp3.Handshake.get(r3)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            dc.squareup.okhttp3.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            ...
            dc.squareup.okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            ...
            r4.append(r0)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            java.lang.String r0 = dc.squareup.okhttp3.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            r4.append(r0)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            java.lang.String r0 = "\n    DN: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            ...
            java.lang.String r0 = "\n    subjectAltNames: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            java.util.List r8 = dc.squareup.okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
        ...
        L_0x00d8:
            dc.squareup.okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            dc.squareup.okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            ...
            dc.squareup.okhttp3.internal.platform.Platform r8 = dc.squareup.okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
        ...
        L_0x00f9:
            ...
            dc.squareup.okio.Source r8 = dc.squareup.okio.Okio.source((java.net.Socket) r1)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            dc.squareup.okio.BufferedSource r8 = dc.squareup.okio.Okio.buffer((dc.squareup.okio.Source) r8)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            r7.source = r8     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            dc.squareup.okio.Sink r8 = dc.squareup.okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            dc.squareup.okio.BufferedSink r8 = dc.squareup.okio.Okio.buffer((dc.squareup.okio.Sink) r8)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            r7.sink = r8     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            r7.handshake = r4     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            if (r2 == 0) goto L_0x011a
            dc.squareup.okhttp3.Protocol r8 = dc.squareup.okhttp3.Protocol.get(r2)     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            goto L_0x011c
        L_0x011a:
            dc.squareup.okhttp3.Protocol r8 = dc.squareup.okhttp3.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
        L_0x011c:
            r7.protocol = r8     // Catch:{ AssertionError -> 0x0129, all -> 0x0126 }
            dc.squareup.okhttp3.internal.platform.Platform r8 = dc.squareup.okhttp3.internal.platform.Platform.get()
        ...
        L_0x012e:
            r8 = move-exception
        L_0x012f:
            boolean r0 = dc.squareup.okhttp3.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x012c }
        ...
        L_0x013c:
            ...
            dc.squareup.okhttp3.internal.platform.Platform r0 = dc.squareup.okhttp3.internal.platform.Platform.get()
            r0.afterHandshake(r2)
        L_0x0145:
            dc.squareup.okhttp3.internal.Util.closeQuietly((java.net.Socket) r2)
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.connection.RealConnection.connectTls(dc.squareup.okhttp3.internal.connection.ConnectionSpecSelector):void");
    }
        ...
        while (true) {
            ...
            if (code != 200) {
                if (code == 407) {
                    ...
                    } else if (AbsoluteConst.EVENTS_CLOSE.equalsIgnoreCase(build.header("Connection"))) {
                        return authenticate;
                    } else {
    ...
    private Request createTunnelRequest() throws IOException {
        Request build = new Request.Builder().url(this.route.address().url()).method("CONNECT", (RequestBody) null).header("Host", Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header(IWebview.USER_AGENT, Version.userAgent()).build();
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void connect(int r17, int r18, int r19, int r20, boolean r21, dc.squareup.okhttp3.Call r22, dc.squareup.okhttp3.EventListener r23) {
        /*
            r16 = this;
            r7 = r16
            r8 = r22
            r9 = r23
            dc.squareup.okhttp3.Protocol r0 = r7.protocol
            if (r0 != 0) goto L_0x0150
            dc.squareup.okhttp3.Route r0 = r7.route
            dc.squareup.okhttp3.Address r0 = r0.address()
            java.util.List r0 = r0.connectionSpecs()
            dc.squareup.okhttp3.internal.connection.ConnectionSpecSelector r10 = new dc.squareup.okhttp3.internal.connection.ConnectionSpecSelector
            r10.<init>(r0)
            dc.squareup.okhttp3.Route r1 = r7.route
            dc.squareup.okhttp3.Address r1 = r1.address()
            javax.net.ssl.SSLSocketFactory r1 = r1.sslSocketFactory()
            if (r1 != 0) goto L_0x0074
            dc.squareup.okhttp3.ConnectionSpec r1 = dc.squareup.okhttp3.ConnectionSpec.CLEARTEXT
            boolean r0 = r0.contains(r1)
            if (r0 == 0) goto L_0x0067
            dc.squareup.okhttp3.Route r0 = r7.route
            dc.squareup.okhttp3.Address r0 = r0.address()
            dc.squareup.okhttp3.HttpUrl r0 = r0.url()
            java.lang.String r0 = r0.host()
            dc.squareup.okhttp3.internal.platform.Platform r1 = dc.squareup.okhttp3.internal.platform.Platform.get()
            boolean r1 = r1.isCleartextTrafficPermitted(r0)
            if (r1 == 0) goto L_0x0046
            goto L_0x0086
        L_0x0046:
            dc.squareup.okhttp3.internal.connection.RouteException r1 = new dc.squareup.okhttp3.internal.connection.RouteException
            ...
            throw r1
        L_0x0067:
            dc.squareup.okhttp3.internal.connection.RouteException r0 = new dc.squareup.okhttp3.internal.connection.RouteException
        ...
        L_0x0074:
            ...
            dc.squareup.okhttp3.Protocol r1 = dc.squareup.okhttp3.Protocol.H2_PRIOR_KNOWLEDGE
            boolean r0 = r0.contains(r1)
        ...
        L_0x0086:
            ...
            r12 = r11
        L_0x0088:
            dc.squareup.okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00f9 }
        ...
        L_0x00b0:
            ...
            dc.squareup.okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00f5 }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x00f5 }
            dc.squareup.okhttp3.Route r1 = r7.route     // Catch:{ IOException -> 0x00f5 }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x00f5 }
            dc.squareup.okhttp3.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x00f5 }
        ...
        L_0x00d3:
            ...
            throw r1
        L_0x00e0:
            dc.squareup.okhttp3.internal.http2.Http2Connection r0 = r7.http2Connection
            if (r0 == 0) goto L_0x00f4
            dc.squareup.okhttp3.ConnectionPool r1 = r7.connectionPool
            monitor-enter(r1)
            dc.squareup.okhttp3.internal.http2.Http2Connection r0 = r7.http2Connection     // Catch:{ all -> 0x00f1 }
        ...
        L_0x0100:
            ...
            dc.squareup.okhttp3.internal.Util.closeQuietly((java.net.Socket) r1)
            ...
            dc.squareup.okhttp3.internal.connection.RouteException r12 = new dc.squareup.okhttp3.internal.connection.RouteException
            r12.<init>(r0)
            goto L_0x0138
        L_0x0135:
