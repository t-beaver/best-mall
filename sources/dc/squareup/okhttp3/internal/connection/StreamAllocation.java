...
public final class StreamAllocation {
    ...
    private dc.squareup.okhttp3.internal.connection.RealConnection findHealthyConnection(int r4, int r5, int r6, int r7, boolean r8, boolean r9) throws java.io.IOException {
        /*
            r3 = this;
        L_0x0000:
            dc.squareup.okhttp3.internal.connection.RealConnection r0 = r3.findConnection(r4, r5, r6, r7, r8)
            dc.squareup.okhttp3.ConnectionPool r1 = r3.connectionPool
            monitor-enter(r1)
        ...
        L_0x0023:
            goto L_0x0022
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.connection.StreamAllocation.findHealthyConnection(int, int, int, int, boolean, boolean):dc.squareup.okhttp3.internal.connection.RealConnection");
    }
    ...
    public boolean hasMoreRoutes() {
        /*
            r1 = this;
            dc.squareup.okhttp3.Route r0 = r1.route
            if (r0 != 0) goto L_0x0019
            dc.squareup.okhttp3.internal.connection.RouteSelector$Selection r0 = r1.routeSelection
            if (r0 == 0) goto L_0x000e
            boolean r0 = r0.hasNext()
            if (r0 != 0) goto L_0x0019
        L_0x000e:
            dc.squareup.okhttp3.internal.connection.RouteSelector r0 = r1.routeSelector
            boolean r0 = r0.hasNext()
        ...
        L_0x001a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.connection.StreamAllocation.hasMoreRoutes():boolean");
    }
    ...
    public void streamFailed(java.io.IOException r7) {
        /*
            r6 = this;
            dc.squareup.okhttp3.ConnectionPool r0 = r6.connectionPool
            monitor-enter(r0)
            boolean r1 = r7 instanceof dc.squareup.okhttp3.internal.http2.StreamResetException     // Catch:{ all -> 0x0065 }
            r2 = 0
            r3 = 0
            r4 = 1
            if (r1 == 0) goto L_0x0023
            dc.squareup.okhttp3.internal.http2.StreamResetException r7 = (dc.squareup.okhttp3.internal.http2.StreamResetException) r7     // Catch:{ all -> 0x0065 }
            dc.squareup.okhttp3.internal.http2.ErrorCode r7 = r7.errorCode     // Catch:{ all -> 0x0065 }
            dc.squareup.okhttp3.internal.http2.ErrorCode r1 = dc.squareup.okhttp3.internal.http2.ErrorCode.REFUSED_STREAM     // Catch:{ all -> 0x0065 }
            ...
            goto L_0x0044
        L_0x001c:
            dc.squareup.okhttp3.internal.http2.ErrorCode r1 = dc.squareup.okhttp3.internal.http2.ErrorCode.CANCEL     // Catch:{ all -> 0x0065 }
            if (r7 == r1) goto L_0x0046
            r6.route = r3     // Catch:{ all -> 0x0065 }
            goto L_0x0044
        L_0x0023:
            dc.squareup.okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x0046
            boolean r1 = r1.isMultiplexed()     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x0031
            boolean r1 = r7 instanceof dc.squareup.okhttp3.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x0046
        L_0x0031:
            dc.squareup.okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0065 }
            int r1 = r1.successCount     // Catch:{ all -> 0x0065 }
            if (r1 != 0) goto L_0x0044
            dc.squareup.okhttp3.Route r1 = r6.route     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x0042
            if (r7 == 0) goto L_0x0042
            dc.squareup.okhttp3.internal.connection.RouteSelector r5 = r6.routeSelector     // Catch:{ all -> 0x0065 }
        ...
        L_0x0047:
            ...
            dc.squareup.okhttp3.internal.connection.RealConnection r2 = r6.connection     // Catch:{ all -> 0x0065 }
        ...
        L_0x0057:
            ...
            dc.squareup.okhttp3.internal.Util.closeQuietly((java.net.Socket) r7)
            if (r3 == 0) goto L_0x0064
            dc.squareup.okhttp3.EventListener r7 = r6.eventListener
            dc.squareup.okhttp3.Call r0 = r6.call
        ...
        L_0x0065:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.connection.StreamAllocation.streamFailed(java.io.IOException):void");
    }
