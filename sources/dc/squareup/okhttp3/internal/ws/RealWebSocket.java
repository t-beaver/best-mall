...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public void failWebSocket(java.lang.Exception r4, dc.squareup.okhttp3.Response r5) {
        /*
            r3 = this;
            monitor-enter(r3)
        ...
        L_0x0007:
            ...
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Streams r0 = r3.streams     // Catch:{ all -> 0x002d }
            r1 = 0
        ...
        L_0x001e:
            monitor-exit(r3)     // Catch:{ all -> 0x002d }
            dc.squareup.okhttp3.WebSocketListener r1 = r3.listener     // Catch:{ all -> 0x0028 }
        ...
        L_0x002d:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.ws.RealWebSocket.failWebSocket(java.lang.Exception, dc.squareup.okhttp3.Response):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void onReadPing(dc.squareup.okio.ByteString r2) {
        /*
            r1 = this;
            monitor-enter(r1)
            ...
            goto L_0x0022
        L_0x0012:
            java.util.ArrayDeque<dc.squareup.okio.ByteString> r0 = r1.pongQueue     // Catch:{ all -> 0x0024 }
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.ws.RealWebSocket.onReadPing(dc.squareup.okio.ByteString):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x005e, code lost:
        if ((r4 instanceof dc.squareup.okhttp3.internal.ws.RealWebSocket.Message) == false) goto L_0x008c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0060, code lost:
        r2 = ((dc.squareup.okhttp3.internal.ws.RealWebSocket.Message) r4).data;
        r0 = dc.squareup.okio.Okio.buffer(r0.newMessageSink(((dc.squareup.okhttp3.internal.ws.RealWebSocket.Message) r4).formatOpcode, (long) r2.size()));
        r0.write(r2);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x008e, code lost:
        if ((r4 instanceof dc.squareup.okhttp3.internal.ws.RealWebSocket.Close) == false) goto L_0x00a5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0090, code lost:
        r4 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Close) r4;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        /*
            ...
            return r1
        L_0x0008:
            dc.squareup.okhttp3.internal.ws.WebSocketWriter r0 = r12.writer     // Catch:{ all -> 0x00b0 }
            java.util.ArrayDeque<dc.squareup.okio.ByteString> r2 = r12.pongQueue     // Catch:{ all -> 0x00b0 }
            java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x00b0 }
            dc.squareup.okio.ByteString r2 = (dc.squareup.okio.ByteString) r2     // Catch:{ all -> 0x00b0 }
            r3 = -1
            r4 = 0
            ...
            boolean r6 = r5 instanceof dc.squareup.okhttp3.internal.ws.RealWebSocket.Close     // Catch:{ all -> 0x00b0 }
            if (r6 == 0) goto L_0x004b
            int r1 = r12.receivedCloseCode     // Catch:{ all -> 0x00b0 }
            java.lang.String r6 = r12.receivedCloseReason     // Catch:{ all -> 0x00b0 }
            if (r1 == r3) goto L_0x0034
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Streams r3 = r12.streams     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0034:
            ...
            dc.squareup.okhttp3.internal.ws.RealWebSocket$CancelRunnable r7 = new dc.squareup.okhttp3.internal.ws.RealWebSocket$CancelRunnable     // Catch:{ all -> 0x00b0 }
            r7.<init>()     // Catch:{ all -> 0x00b0 }
            r8 = r5
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Close r8 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0055:
            ...
            goto L_0x00a0
        L_0x005c:
            boolean r2 = r4 instanceof dc.squareup.okhttp3.internal.ws.RealWebSocket.Message     // Catch:{ all -> 0x00ab }
            if (r2 == 0) goto L_0x008c
            r2 = r4
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Message r2 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Message) r2     // Catch:{ all -> 0x00ab }
            dc.squareup.okio.ByteString r2 = r2.data     // Catch:{ all -> 0x00ab }
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Message r4 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Message) r4     // Catch:{ all -> 0x00ab }
            int r3 = r4.formatOpcode     // Catch:{ all -> 0x00ab }
            int r4 = r2.size()     // Catch:{ all -> 0x00ab }
            long r4 = (long) r4     // Catch:{ all -> 0x00ab }
            dc.squareup.okio.Sink r0 = r0.newMessageSink(r3, r4)     // Catch:{ all -> 0x00ab }
            dc.squareup.okio.BufferedSink r0 = dc.squareup.okio.Okio.buffer((dc.squareup.okio.Sink) r0)     // Catch:{ all -> 0x00ab }
            r0.write((dc.squareup.okio.ByteString) r2)     // Catch:{ all -> 0x00ab }
        ...
        L_0x008c:
            boolean r2 = r4 instanceof dc.squareup.okhttp3.internal.ws.RealWebSocket.Close     // Catch:{ all -> 0x00ab }
            if (r2 == 0) goto L_0x00a5
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Close r4 = (dc.squareup.okhttp3.internal.ws.RealWebSocket.Close) r4     // Catch:{ all -> 0x00ab }
            int r2 = r4.code     // Catch:{ all -> 0x00ab }
            dc.squareup.okio.ByteString r4 = r4.reason     // Catch:{ all -> 0x00ab }
            r0.writeClose(r2, r4)     // Catch:{ all -> 0x00ab }
            if (r1 == 0) goto L_0x00a0
            dc.squareup.okhttp3.WebSocketListener r0 = r12.listener     // Catch:{ all -> 0x00ab }
        ...
        L_0x00b0:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x001e, code lost:
        failWebSocket(new java.net.SocketTimeoutException("sent ping but didn't receive pong within " + r7.pingIntervalMillis + "ms (after " + (r1 - 1) + " successful ping/pongs)"), (dc.squareup.okhttp3.Response) null);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0047, code lost:
        return;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        r0.writePing(dc.squareup.okio.ByteString.EMPTY);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x004e, code lost:
        r0 = move-exception;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x004f, code lost:
        failWebSocket(r0, (dc.squareup.okhttp3.Response) null);
     */
    ...
    public void writePingFrame() {
        /*
            ...
            return
        L_0x0007:
            dc.squareup.okhttp3.internal.ws.WebSocketWriter r0 = r7.writer     // Catch:{ all -> 0x0053 }
        ...
        L_0x0012:
            ...
            return
        L_0x0048:
            dc.squareup.okio.ByteString r1 = dc.squareup.okio.ByteString.EMPTY     // Catch:{ IOException -> 0x004e }
        ...
        L_0x0053:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.ws.RealWebSocket.writePingFrame():void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized boolean send(dc.squareup.okio.ByteString r7, int r8) {
        /*
            r6 = this;
            monitor-enter(r6)
        ...
        L_0x0022:
            ...
            dc.squareup.okhttp3.internal.ws.RealWebSocket$Message r1 = new dc.squareup.okhttp3.internal.ws.RealWebSocket$Message     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.ws.RealWebSocket.send(dc.squareup.okio.ByteString, int):boolean");
    }
}
