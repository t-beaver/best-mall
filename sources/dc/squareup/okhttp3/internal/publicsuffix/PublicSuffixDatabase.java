...
public final class PublicSuffixDatabase {
        ...
        while (i4 < length) {
            ...
            while (true) {
                if (z2) {
                    ...
                    z = z2;
                    b = bArr4[i9][i10] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
                }
                i3 = b - (bArr3[i6 + i11] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
                if (i3 == 0) {
                    i11++;
                    i10++;
                    if (i11 == i8) {
    ...
    private void readTheListUninterruptibly() {
        ...
        L_0x0010:
            r1 = move-exception
            dc.squareup.okhttp3.internal.platform.Platform r2 = dc.squareup.okhttp3.internal.platform.Platform.get()     // Catch:{ all -> 0x000e }
            r3 = 5
        ...
        L_0x0035:
            goto L_0x0034
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.publicsuffix.PublicSuffixDatabase.readTheListUninterruptibly():void");
    }
