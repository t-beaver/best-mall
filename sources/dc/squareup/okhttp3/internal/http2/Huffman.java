...
class Huffman {
    ...
    public byte[] decode(byte[] bArr) {
        ...
        int i = 0;
        for (byte b2 : bArr) {
            b = (b << 8) | (b2 & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
            i += 8;
            while (i >= 8) {
    ...
    public void encode(dc.squareup.okio.ByteString r8, dc.squareup.okio.BufferedSink r9) throws java.io.IOException {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x003b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.http2.Huffman.encode(dc.squareup.okio.ByteString, dc.squareup.okio.BufferedSink):void");
    }
    ...
    public int encodedLength(ByteString byteString) {
        ...
        for (int i = 0; i < byteString.size(); i++) {
            j += (long) CODE_LENGTHS[byteString.getByte(i) & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE];
        }
        return (int) ((j + 7) >> 3);
    }
