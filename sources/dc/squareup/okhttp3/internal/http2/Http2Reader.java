...
final class Http2Reader implements Closeable {
    ...
    static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            byte readByte = (byte) (this.source.readByte() & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
            this.flags = (byte) (this.source.readByte() & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
    ...
    private void readData(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        if (i2 != 0) {
            ...
            if (!z) {
                if ((b & 8) != 0) {
                    s = (short) (this.source.readByte() & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
                }
    ...
    public boolean nextFrame(boolean z, Handler handler) throws IOException {
        try {
            ...
            byte readByte = (byte) (this.source.readByte() & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
            if (!z || readByte == 4) {
                byte readByte2 = (byte) (this.source.readByte() & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
                int readInt = this.source.readInt() & Integer.MAX_VALUE;
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        int readInt = this.source.readInt();
        handler.priority(i, readInt & Integer.MAX_VALUE, (this.source.readByte() & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
}
