...
final class Base64 {
    ...
    private static String encode(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2 += 3) {
            int i3 = i + 1;
            bArr3[i] = bArr2[(bArr[i2] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) >> 2];
            int i4 = i3 + 1;
            int i5 = i2 + 1;
            bArr3[i3] = bArr2[((bArr[i2] & 3) << 4) | ((bArr[i5] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) >> 4)];
            int i6 = i4 + 1;
            int i7 = i2 + 2;
            bArr3[i4] = bArr2[((bArr[i5] & 15) << 2) | ((bArr[i7] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) >> 6)];
            i = i6 + 1;
        ...
        if (length2 == 1) {
            int i8 = i + 1;
            bArr3[i] = bArr2[(bArr[length] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) >> 2];
            int i9 = i8 + 1;
            ...
            int i11 = i10 + 1;
            int i12 = length + 1;
            bArr3[i10] = bArr2[((bArr[i12] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) >> 4) | ((bArr[length] & 3) << 4)];
