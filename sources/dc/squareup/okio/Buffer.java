...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
        ...
        public final int seek(long j) {
            ...
            if (i >= 0) {
                ...
                if (j <= j2) {
                    ...
                    if (j2 - j > j - j3) {
                        while (true) {
                            long j5 = ((long) (segment3.limit - segment3.pos)) + j3;
                            if (j < j5) {
                                break;
                            }
    ...
    public InputStream inputStream() {
        return new InputStream() {
            ...
            public int read() {
                ...
                if (buffer.size > 0) {
                    return buffer.readByte() & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
                }
                return -1;
            }
    ...
    public long readDecimalLong() {
        /*
            ...
            r9 = 0
        L_0x0014:
            dc.squareup.okio.Segment r10 = r0.head
            byte[] r11 = r10.data
            int r12 = r10.pos
            int r13 = r10.limit
        L_0x001c:
        ...
        L_0x0036:
            ...
            goto L_0x0074
        L_0x003d:
            dc.squareup.okio.Buffer r1 = new dc.squareup.okio.Buffer
            r1.<init>()
            dc.squareup.okio.Buffer r1 = r1.writeDecimalLong((long) r3)
            dc.squareup.okio.Buffer r1 = r1.writeByte((int) r15)
        ...
        L_0x009d:
            ...
            dc.squareup.okio.Segment r1 = r10.pop()
            r0.head = r1
            dc.squareup.okio.SegmentPool.recycle(r10)
            goto L_0x00ab
        L_0x00a9:
            r10.pos = r12
        L_0x00ab:
            if (r9 != 0) goto L_0x00b9
            dc.squareup.okio.Segment r1 = r0.head
    ...
    public long readHexadecimalUnsignedLong() {
        /*
            ...
            r1 = 0
        L_0x000b:
            dc.squareup.okio.Segment r6 = r15.head
            byte[] r7 = r6.data
            int r8 = r6.pos
            int r9 = r6.limit
        L_0x0013:
        ...
        L_0x004a:
            ...
            r0.<init>()
            dc.squareup.okio.Buffer r0 = r0.writeHexadecimalUnsignedLong((long) r4)
            dc.squareup.okio.Buffer r0 = r0.writeByte((int) r10)
            java.lang.NumberFormatException r1 = new java.lang.NumberFormatException
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
    ...
    public int readInt() {
        ...
        if (j >= 4) {
            ...
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) << 24) | ((bArr[i3] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) << 16);
            int i5 = i4 + 1;
            byte b2 = b | ((bArr[i4] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) << 8);
            int i6 = i5 + 1;
            byte b3 = b2 | (bArr[i5] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
            this.size = j - 4;
            if (i6 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    public short readShort() {
        ...
        if (j >= 2) {
            ...
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) << 8) | (bArr[i3] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE);
            this.size = j - 2;
            if (i4 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
            ...
            while (true) {
                ...
                if (i11 < 0) {
                    ...
                    while (true) {
                        int i15 = i6 + 1;
                        int i16 = i12 + 1;
                        if ((bArr[i6] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) != iArr[i12]) {
                            return i9;
                        }
                        boolean z2 = i16 == i14;
                        if (i15 == i7) {
                    ...
                    int i17 = i6 + 1;
                    byte b = bArr[i6] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
                    int i18 = i12 + i11;
                    while (i12 != i18) {
                        if (b == iArr[i12]) {
                            i = iArr[i12 + i11];
            ...
            while (i < i2) {
                ...
                if (charAt2 < 128) {
                    ...
                    if (charAt2 < 2048) {
                        ...
                        writeByte((int) (charAt2 & Operators.CONDITION_IF) | 128);
                        ...
                        if (charAt2 > 56319 || c < 56320 || c > 57343) {
                            ...
                            int i8 = (((charAt2 & 10239) << 10) | (9215 & c)) + 0;
    ...
    public final Buffer copyTo(Buffer buffer, long j, long j2) {
        if (buffer != null) {
            ...
            while (j2 > 0) {
                ...
                int i = (int) (((long) sharedCopy.pos) + j);
                sharedCopy.pos = i;
