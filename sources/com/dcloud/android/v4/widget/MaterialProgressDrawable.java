...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas canvas, float f, float f2, Rect rect) {
            if (this.mShowArrow) {
                ...
                path3.lineTo((((float) this.mArrowWidth) * f5) / 2.0f, ((float) this.mArrowHeight) * f5);
    ...
    public MaterialProgressDrawable(Context context, View view) {
        int[] iArr = {-16777216};
        this.COLORS = iArr;
        AnonymousClass3 r2 = new Drawable.Callback() {
    ...
    private void setupAnimators() {
        ...
        AnonymousClass1 r1 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                float access$100 = materialProgressDrawable.getMinProgressArc(ring);
                ...
                if (f <= 0.5f) {
                    ...
                    ring.setStartTrim(startingStartTrim + (f2 * access$300.getInterpolation(f / 0.5f)));
                }
                if (f > 0.5f) {
                    ...
                    ring.setEndTrim(startingEndTrim + (f3 * access$3002.getInterpolation((f - 0.5f) / 0.5f)));
                }
