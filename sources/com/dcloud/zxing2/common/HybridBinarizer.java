    ...
    private static int[][] calculateBlackPoints(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        for (int i7 = 0; i7 < i6; i7++) {
            ...
            for (int i10 = 0; i10 < i5; i10++) {
                ...
                int i14 = 0;
                byte b = 0;
                byte b2 = IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
                int i15 = 0;
                while (i14 < 8) {
                    for (int i16 = 0; i16 < 8; i16++) {
                        byte b3 = bArr[i13 + i16] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
                        i15 += b3;
                        if (b3 < b2) {
                            b2 = b3;
                        }
                    ...
                    while (true) {
                        ...
                        for (int i17 = 0; i17 < 8; i17++) {
                            i15 += bArr[i13 + i17] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
                        }
                    }
                    i14++;
                    i13 += i3;
    ...
    private static void thresholdBlock(byte[] bArr, int i, int i2, int i3, int i4, BitMatrix bitMatrix) {
        ...
        while (i6 < 8) {
            for (int i7 = 0; i7 < 8; i7++) {
                if ((bArr[i5 + i7] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE) <= i3) {
