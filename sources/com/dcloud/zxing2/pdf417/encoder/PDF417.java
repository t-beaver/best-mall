...
public final class PDF417 {
    ...
    public void generateBarcodeLogic(String str, int i) throws WriterException {
        ...
        if (errorCorrectionCodewordCount + length + 1 <= 929) {
            ...
            BarcodeMatrix barcodeMatrix2 = new BarcodeMatrix(i3, i2);
            this.barcodeMatrix = barcodeMatrix2;
            encodeLowLevel(sb2 + PDF417ErrorCorrection.generateErrorCorrection(sb2, i), i2, i3, i, barcodeMatrix2);
            return;
        }
