...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        while (this.nbCenterLayers < 9) {
            ...
            if (this.nbCenterLayers > 2) {
                double distance = (double) ((distance(firstDifferent4, firstDifferent) * ((float) this.nbCenterLayers)) / (distance(point2, point5) * ((float) (this.nbCenterLayers + 2))));
        ...
        if (i == 5 || i == 7) {
            this.compact = i == 5;
            ResultPoint[] resultPointArr = {new ResultPoint(((float) point5.getX()) + 0.5f, ((float) point5.getY()) - 0.5f), new ResultPoint(((float) point4.getX()) + 0.5f, ((float) point4.getY()) + 0.5f), new ResultPoint(((float) point3.getX()) - 0.5f, ((float) point3.getY()) + 0.5f), new ResultPoint(((float) point2.getX()) - 0.5f, ((float) point2.getY()) - 0.5f)};
            int i2 = this.nbCenterLayers * 2;
            return expandSquare(resultPointArr, (float) (i2 - 3), (float) i2);
        }
        throw NotFoundException.getNotFoundInstance();
    }
    ...
    private BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4) throws NotFoundException {
        ...
        float f2 = (float) this.nbCenterLayers;
        float f3 = f - f2;
        float f4 = f + f2;
        return instance.sampleGrid(bitMatrix, i2, i, f3, f3, f4, f3, f4, f4, f3, f4, resultPoint.getX(), resultPoint.getY(), resultPoint2.getX(), resultPoint2.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint4.getX(), resultPoint4.getY());
    }
