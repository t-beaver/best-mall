...
public final class Downsampler {
            ...
            if (downsampler.shouldUsePool(imageType)) {
                if (i14 < 0 || i13 < 0 || !z2 || !z3) {
                    ...
                    if (Log.isLoggable(TAG, 2)) {
                        Log.v(TAG, "Calculated target [" + i5 + Constants.Name.X + i4 + "] for source [" + i14 + Constants.Name.X + i13 + "], sampleSize: " + i15 + ", targetDensity: " + options3.inTargetDensity + ", density: " + options3.inDensity + ", density multiplier: " + f);
                    }
                } else {
                    i5 = i10;
                    i4 = i11;
    ...
    private static void calculateScaling(ImageHeaderParser.ImageType imageType, InputStream inputStream, DecodeCallbacks decodeCallbacks, BitmapPool bitmapPool2, DownsampleStrategy downsampleStrategy, int i, int i2, int i3, int i4, int i5, BitmapFactory.Options options) throws IOException {
        ...
        if (i11 <= 0 || i12 <= 0) {
            String str = TAG;
            String str2 = Constants.Name.X;
            if (Log.isLoggable(str, 3)) {
                Log.d(str, "Unable to determine dimensions for: " + imageType2 + " with target [" + i13 + str2 + i14 + Operators.ARRAY_END_STR);
                return;
            }
            return;
        }
        ...
        String str7 = Constants.Name.X;
        throw new IllegalArgumentException("Cannot scale with factor: " + f + " from: " + downsampleStrategy2 + ", source: [" + i11 + str7 + i12 + "], target: [" + i13 + str7 + i14 + Operators.ARRAY_END_STR);
    }
