...
final class ResourceCacheKey implements Key {
    ...
    public String toString() {
        return "ResourceCacheKey{sourceKey=" + this.sourceKey + ", signature=" + this.signature + ", width=" + this.width + ", height=" + this.height + ", decodedResourceClass=" + this.decodedResourceClass + ", transformation='" + this.transformation + Operators.SINGLE_QUOTE + ", options=" + this.options + Operators.BLOCK_END;
    }
}
