...
public class DirectorySoSource extends SoSource {
    ...
    private static String[] getDependencies(File file) throws IOException {
        if (SoLoader.SYSTRACE_LIBRARY_LOADING) {
            Api18TraceUtils.beginTraceSection("SoLoader.getElfDependencies[", file.getName(), Operators.ARRAY_END_STR);
        }
        try {
    ...
    public String toString() {
        ...
        return getClass().getName() + "[root = " + str + " flags = " + this.flags + Operators.ARRAY_END;
    }
}
