    ...
    private final class ExoUnpacker extends UnpackingSoSource.Unpacker {
        ...
        ExoUnpacker(com.facebook.soloader.ExoSoSource r18, com.facebook.soloader.UnpackingSoSource r19) throws java.io.IOException {
            ...
            L_0x005e:
                ...
                r10.<init>(r8)
                java.io.BufferedReader r8 = new java.io.BufferedReader     // Catch:{ all -> 0x0105 }
                r8.<init>(r10)     // Catch:{ all -> 0x0105 }
            L_0x0068:
            ...
            L_0x00fb:
                r0 = move-exception
                r4 = r0
                r2.addSuppressed(r4)     // Catch:{ all -> 0x0105 }
                goto L_0x0104
            L_0x0101:
                r8.close()     // Catch:{ all -> 0x0105 }
            L_0x0104:
