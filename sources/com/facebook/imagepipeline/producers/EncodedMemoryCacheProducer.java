            ...
            if (closeableReference != null) {
                try {
                    ...
                    if (producerListener.requiresExtraMap(producerContext2, PRODUCER_NAME)) {
                        map = ImmutableMap.of("cached_value_found", AbsoluteConst.TRUE);
                    }
                ...
                producerListener.onProducerFinishWithSuccess(producerContext2, PRODUCER_NAME, producerListener.requiresExtraMap(producerContext2, PRODUCER_NAME) ? ImmutableMap.of("cached_value_found", AbsoluteConst.FALSE) : null);
                ...
                if (producerListener.requiresExtraMap(producerContext2, PRODUCER_NAME)) {
                    map = ImmutableMap.of("cached_value_found", AbsoluteConst.FALSE);
                }
                producerListener.onProducerFinishWithSuccess(producerContext2, PRODUCER_NAME, map);
