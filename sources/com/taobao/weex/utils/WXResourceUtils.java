...
public class WXResourceUtils {
        ...
        NAMED_COLOR_HANDLER {
            ...
            public Pair<Boolean, Integer> handle(String str) {
                if (WXResourceUtils.colorMap.containsKey(str)) {
                    return new Pair<>(Boolean.TRUE, (Integer) WXResourceUtils.colorMap.get(str));
                }
    ...
    private static float[] parseGradientDirection(java.lang.String r8, float r9, float r10) {
        ...
        L_0x001a:
            ...
            r7 = 0
            switch(r3) {
                case -1352032154: goto L_0x0060;
                case -1137407871: goto L_0x0055;
                case -868157182: goto L_0x004a;
                case -172068863: goto L_0x003f;
                case 110550266: goto L_0x0036;
                case 1176531318: goto L_0x002b;
