...
public enum WXErrorCode {
    ...
    WX_SUCCESS(WXInstanceApm.VALUE_ERROR_CODE_DEFAULT, "successful", ErrorType.NATIVE_ERROR, ErrorGroup.NATIVE),
    ...
    WX_KEY_EXCEPTION_VALIDAPPKEY("-11001", "", ErrorType.NATIVE_ERROR, ErrorGroup.NATIVE),
    ...
    WX_ERROR_MOVE_RENDER_OBJECT_OUT_OF_BOUNDS("-2120", "Index out of bounds when move element", ErrorType.NATIVE_ERROR, ErrorGroup.JS),
