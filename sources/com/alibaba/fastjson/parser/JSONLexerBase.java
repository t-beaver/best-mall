...
public abstract class JSONLexerBase implements JSONLexer, Closeable {
    ...
    public String scanFieldString(char[] cArr) {
        ...
        int indexOf = indexOf(Operators.QUOTE, this.bp + cArr.length + 1);
        if (indexOf != -1) {
    ...
    public long scanEnumSymbol(char[] cArr) {
        ...
        while (true) {
            ...
            if (charAt == '\"') {
                ...
                j = (j ^ ((long) ((charAt < 'A' || charAt > 'Z') ? charAt : charAt + ' '))) * TypeUtils.fnv1a_64_magic_prime;
                if (charAt == '\\') {
                    this.matchStat = -1;
                    return 0;
                }
    ...
    public java.math.BigDecimal scanFieldDecimal(char[] r18) {
        ...
        L_0x00eb:
            ...
            java.math.BigDecimal r5 = new java.math.BigDecimal
            int r6 = r1.length
            java.math.MathContext r8 = java.math.MathContext.UNLIMITED
            r5.<init>(r1, r2, r6, r8)
    ...
    public Date scanFieldDate(char[] cArr) {
        ...
        char charAt2 = charAt(this.bp + length);
        if (charAt2 == '\"') {
            int indexOf = indexOf(Operators.QUOTE, this.bp + cArr2.length + 1);
            if (indexOf != -1) {
    ...
    public Date scanDate(char c) {
        ...
        int i2 = 5;
        if (charAt == '\"') {
            int indexOf = indexOf(Operators.QUOTE, this.bp + 1);
            if (indexOf != -1) {
                int i3 = this.bp + 1;
    ...
    public final void scanIdent() {
        ...
        if ("null".equalsIgnoreCase(stringVal)) {
            ...
            this.token = 9;
        } else if (AbsoluteConst.TRUE.equals(stringVal)) {
            this.token = 6;
        } else if (AbsoluteConst.FALSE.equals(stringVal)) {
            this.token = 7;
        } else if (Constants.Name.UNDEFINED.equals(stringVal)) {
            this.token = 23;
