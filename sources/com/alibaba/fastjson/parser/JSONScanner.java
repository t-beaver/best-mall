...
public final class JSONScanner extends JSONLexerBase {
    ...
    private boolean scanISO8601DateIfMatch(boolean r35, int r36) {
        ...
        L_0x00c8:
            ...
            if (r10 == r11) goto L_0x0593
            if (r10 != r14) goto L_0x00e8
            int r5 = r9.bp
            int r5 = r5 + 10
        ...
        L_0x0216:
            ...
            r0 = 16
            if (r10 != r0) goto L_0x02b8
            r0 = 8
            if (r13 != r0) goto L_0x02b8
            int r0 = r9.bp
            int r0 = r0 + 15
            char r0 = r9.charAt(r0)
            r1 = 90
        ...
        L_0x0531:
            ...
            char r5 = r9.charAt(r5)
            r7 = 48
            if (r5 != r7) goto L_0x0544
            goto L_0x052c
        L_0x0544:
            r4 = 52
            if (r0 != r4) goto L_0x0561
            int r0 = r9.bp
            int r0 = r0 + r13
            int r0 = r0 + 10
            int r0 = r0 + r6
    ...
    public String scanFieldString(char[] cArr) {
        ...
        int indexOf = indexOf(Operators.QUOTE, i2);
        if (indexOf != -1) {
            ...
            if (subString.indexOf(92) != -1) {
                while (true) {
                    ...
                    indexOf = indexOf(Operators.QUOTE, indexOf + 1);
                }
    ...
    public Date scanFieldDate(char[] cArr) {
        ...
        char charAt = charAt(length);
        if (charAt == '\"') {
            int indexOf = indexOf(Operators.QUOTE, i3);
            if (indexOf != -1) {
                this.bp = i3;
    ...
    public Collection<String> scanFieldStringArray(char[] cArr, Class<?> cls) {
        ...
        if (charAt(length) == '[') {
            ...
            while (true) {
                if (charAt == '\"') {
                    int indexOf = indexOf(Operators.QUOTE, i8);
                    if (indexOf != i7) {
    ...
    public Date scanDate(char c) {
        ...
        if (charAt == '\"') {
            int indexOf = indexOf(Operators.QUOTE, i4);
            if (indexOf != -1) {
                this.bp = i4;
        ...
        if (c == '[') {
            ...
            while (true) {
                if (isWhitespace(this.ch)) {
                    ...
                    String scanSymbol = scanSymbol(symbolTable, Operators.QUOTE);
                    if (i5 == strArr.length) {
