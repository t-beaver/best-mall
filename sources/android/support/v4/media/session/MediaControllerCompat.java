    ...
    static void validateCustomAction(String str, Bundle bundle) {
        if (str != null) {
            ...
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + str + Operators.DOT_STR);
            }
        }
    }
