...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        this.uncheckCircleColor = optColor(obtainStyledAttributes, R.styleable.SwitchButton_sb_uncheckcircle_color, 0);
        ...
        this.shadowRadius = optPixelSize(obtainStyledAttributes, R.styleable.SwitchButton_sb_shadow_radius, dp2pxInt(2.0f));
        this.shadowOffset = optPixelSize(obtainStyledAttributes, R.styleable.SwitchButton_sb_shadow_offset, dp2pxInt(0.0f));
        ...
        this.checkedColor = optColor(obtainStyledAttributes, R.styleable.SwitchButton_sb_checked_color, -16466430);
        this.borderWidth = optPixelSize(obtainStyledAttributes, R.styleable.SwitchButton_sb_border_width, dp2pxInt(1.0f));
        this.checkLineColor = optColor(obtainStyledAttributes, R.styleable.SwitchButton_sb_checkline_color, 0);
        this.checkLineWidth = optPixelSize(obtainStyledAttributes, R.styleable.SwitchButton_sb_checkline_width, dp2pxInt(0.0f));
    ...
    public float getShadowBottomSize() {
        return ((float) ((this.shadowRadius + this.shadowOffset) - this.borderWidth)) - 2.0f;
    }

    public float getShadowLeftSize() {
        return ((float) (this.shadowRadius - this.borderWidth)) - 2.0f;
    }
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        float f = ((float) i2) - ((float) (i5 - i6));
        this.height = f;
        float f2 = (float) i;
        this.width = f2;
        float f3 = f * 0.5f;
        this.viewRadius = f3;
        this.buttonRadius = f3 - ((float) i6);
        float f4 = ((float) i6) / 2.0f;
        this.left = f4;
        float f5 = ((float) i6) / 2.0f;
        this.top = f5;
        float f6 = f2 - (((float) i6) / 2.0f);
        this.right = f6;
        float f7 = f - (((float) i6) / 2.0f);
        this.bottom = f7;
        this.centerX = (f6 + f4) * 0.5f;
        this.centerY = (f5 + f7) * 0.5f;
        this.buttonMinX = (f4 / 2.0f) + f3;
        this.buttonMaxX = ((f2 - (((float) i6) / 2.0f)) + ((((float) i6) / 2.0f) / 2.0f)) - f3;
        if (isChecked()) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        drawRoundRect(canvas2, this.left + f, this.top + f, this.right - f, this.bottom - f, this.viewRadius, this.paint);
        this.paint.setStyle(Paint.Style.FILL);
        this.paint.setStrokeWidth(1.0f);
        float f2 = this.left;
        float f3 = this.top;
        float f4 = this.viewRadius;
        drawArc(canvas2, f2, f3, f2 + (f4 * 2.0f), ((f4 * 2.0f) + f3) - ((float) this.borderWidth), 90.0f, 180.0f, this.paint);
        canvas.drawRect(this.left + this.viewRadius, this.top, this.viewState.buttonX, (this.top + (this.viewRadius * 2.0f)) - ((float) this.borderWidth), this.paint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (isPendingDragState()) {
                ...
                viewState2.buttonX = f + ((this.buttonMaxX - f) * this.dragFraction);
            } else if (isDragState()) {
                float width3 = x / ((float) getWidth());
                this.dragFraction = width3;
                this.dragFraction = Math.max(0.0f, Math.min(1.0f, width3));
                Logger.d("ACTION_MOVE", "isDragState =========== " + this.dragFraction);
                ViewState viewState3 = this.viewState;
                float f2 = this.buttonMinX;
                viewState3.buttonX = f2 + ((this.buttonMaxX - f2) * this.dragFraction);
                this.viewState.checkStateColor = ((Integer) this.argbEvaluator.evaluate(this.dragFraction, Integer.valueOf(this.uncheckColor), Integer.valueOf(this.checkedColor))).intValue();
                postInvalidate();
            }
