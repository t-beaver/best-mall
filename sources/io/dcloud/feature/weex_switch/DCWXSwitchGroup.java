...
public class DCWXSwitchGroup extends WXComponent<SwitchGroup> {
    ...
    public void setChecked(boolean z) {
        ((SwitchButton) ((SwitchGroup) getHostView()).getChildAt(0)).setChecked(z);
    }

    @WXComponentProp(name = "disabled")
    public void setDisabled(boolean z) {
        ((SwitchButton) ((SwitchGroup) getHostView()).getChildAt(0)).setEnabled(!z);
    }

    @WXComponentProp(name = "color")
    public void setColor(String str) {
        ((SwitchButton) ((SwitchGroup) getHostView()).getChildAt(0)).setCheckedColor(Color.parseColor(str));
    }

    public void addEvent(String str) {
        super.addEvent(str);
        if (str != null && str.equals(Constants.Event.CHANGE) && getHostView() != null) {
            ((SwitchButton) ((SwitchGroup) getHostView()).getChildAt(0)).setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
                public void onCheckedChanged(SwitchButton switchButton, boolean z) {
                    HashMap hashMap = new HashMap();
                    HashMap hashMap2 = new HashMap();
                    hashMap2.put("value", z + "");
                    hashMap.put("detail", hashMap2);
                    DCWXSwitchGroup.this.fireEvent(Constants.Event.CHANGE, hashMap);
                }
            });
        }
    }
    ...
    public void removeEventFromView(String str) {
        ...
        if (getHostView() != null && Constants.Event.CHANGE.equals(str)) {
            ((SwitchButton) ((SwitchGroup) getHostView()).getChildAt(0)).setOnCheckedChangeListener((SwitchButton.OnCheckedChangeListener) null);
        }
    }
}
