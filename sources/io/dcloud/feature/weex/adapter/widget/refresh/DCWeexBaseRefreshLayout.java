...
public class DCWeexBaseRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
        ...
        this.mRefreshListener = new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (DCWeexBaseRefreshLayout.this.mRefreshing) {
                    ...
                    int unused = dCWeexBaseRefreshLayout.mCurrentTargetOffsetTop = dCWeexBaseRefreshLayout.mCircleView.getTop();
                    return;
                }
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                if (!DCWeexBaseRefreshLayout.this.mUsingCustomStart) {
                    f2 = DCWeexBaseRefreshLayout.this.mSpinnerFinalOffset - ((float) Math.abs(DCWeexBaseRefreshLayout.this.mOriginalOffsetTop));
                } else {
                    f2 = DCWeexBaseRefreshLayout.this.mSpinnerFinalOffset;
                }
                DCWeexBaseRefreshLayout.this.setTargetOffsetTopAndBottom((DCWeexBaseRefreshLayout.this.mFrom + ((int) (((float) (((int) f2) - DCWeexBaseRefreshLayout.this.mFrom)) * f))) - DCWeexBaseRefreshLayout.this.mCircleView.getTop(), false);
    ...
    public void beginRefresh() {
        if (!this.mBeginRefresh && this.mCircleView.getVisibility() != 0) {
            post(new Runnable() {
                ...
                public void run() {
                    if (((float) this.offset) < DCWeexBaseRefreshLayout.this.mTotalDragDistance) {
                        DCWeexBaseRefreshLayout.this.moveSpinner((float) this.offset);
                        DCWeexBaseRefreshLayout.this.postDelayed(this, 1);
                        this.offset += 15;
                        return;
                    }
                    DCWeexBaseRefreshLayout.this.setRefreshing(true, true);
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        ...
        AnonymousClass5 r0 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                MaterialProgressDrawable access$100 = DCWeexBaseRefreshLayout.this.mProgress;
                int i = i;
                access$100.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        r0.setDuration(300);
    ...
    public boolean canChildScrollUp() {
        ...
        if (view2 instanceof AbsListView) {
            ...
            return false;
        } else if (ViewCompat.canScrollVertically(view2, -1) || this.mTarget.getScrollY() > 0) {
            return true;
        } else {
            return false;
        }
            ...
            r0 = new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    if (!DCWeexBaseRefreshLayout.this.mScale) {
                        DCWeexBaseRefreshLayout.this.startScaleDownAnimation((Animation.AnimationListener) null);
                    }
                }
            };
        }
    ...
    private void startScaleDownReturnToStartAnimation(int i, Animation.AnimationListener animationListener) {
        ...
        AnonymousClass9 r3 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
