...
public class ExifInterface {
    ...
    private static class ExifAttribute {
        ...
        public java.lang.Object getValue(java.nio.ByteOrder r11) {
            /*
                ...
                r2 = 0
                io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream r3 = new io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream     // Catch:{ IOException -> 0x018d, all -> 0x018b }
            ...
            L_0x004d:
                int r11 = r10.numberOfComponents     // Catch:{ IOException -> 0x0189 }
                io.dcloud.common.util.ExifInterface$Rational[] r11 = new io.dcloud.common.util.ExifInterface.Rational[r11]     // Catch:{ IOException -> 0x0189 }
            L_0x0051:
                int r4 = r10.numberOfComponents     // Catch:{ IOException -> 0x0189 }
                ...
                io.dcloud.common.util.ExifInterface$Rational r4 = new io.dcloud.common.util.ExifInterface$Rational     // Catch:{ IOException -> 0x0189 }
            ...
            L_0x00fd:
                int r11 = r10.numberOfComponents     // Catch:{ IOException -> 0x0189 }
                byte[] r6 = io.dcloud.common.util.ExifInterface.EXIF_ASCII_PREFIX     // Catch:{ IOException -> 0x0189 }
            ...
            L_0x016e:
                java.lang.String r11 = new java.lang.String     // Catch:{ IOException -> 0x0189 }
                byte[] r4 = r10.bytes     // Catch:{ IOException -> 0x0189 }
                java.nio.charset.Charset r5 = io.dcloud.common.util.ExifInterface.ASCII     // Catch:{ IOException -> 0x0189 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:22:0x007b A[Catch:{ all -> 0x0153 }] */
    /* JADX WARNING: Removed duplicated region for block: B:27:0x0090 A[Catch:{ all -> 0x0153 }] */
    /* JADX WARNING: Removed duplicated region for block: B:33:0x00a6 A[Catch:{ all -> 0x0153 }] */
    /* JADX WARNING: Removed duplicated region for block: B:51:0x00db A[Catch:{ all -> 0x0153 }] */
    /* JADX WARNING: Removed duplicated region for block: B:64:0x0118 A[Catch:{ all -> 0x0153 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void getHeifAttributes(final io.dcloud.common.util.ExifInterface.ByteOrderedDataInputStream r14) throws java.io.IOException {
        /*
            r13 = this;
            ...
            io.dcloud.common.util.ExifInterface$1 r2 = new io.dcloud.common.util.ExifInterface$1     // Catch:{ all -> 0x0153 }
            r2.<init>(r14)     // Catch:{ all -> 0x0153 }
            r1.setDataSource(r2)     // Catch:{ all -> 0x0153 }
            goto L_0x0026
        L_0x0017:
            java.io.FileDescriptor r2 = r13.mSeekableFileDescriptor     // Catch:{ all -> 0x0153 }
            if (r2 == 0) goto L_0x001f
            r1.setDataSource(r2)     // Catch:{ all -> 0x0153 }
            goto L_0x0026
        L_0x001f:
            java.lang.String r2 = r13.mFilename     // Catch:{ all -> 0x0153 }
            if (r2 == 0) goto L_0x014f
            r1.setDataSource(r2)     // Catch:{ all -> 0x0153 }
        L_0x0026:
            r2 = 33
            java.lang.String r2 = r1.extractMetadata(r2)     // Catch:{ all -> 0x0153 }
            r3 = 34
            java.lang.String r3 = r1.extractMetadata(r3)     // Catch:{ all -> 0x0153 }
            r4 = 26
            java.lang.String r4 = r1.extractMetadata(r4)     // Catch:{ all -> 0x0153 }
            r5 = 17
            java.lang.String r5 = r1.extractMetadata(r5)     // Catch:{ all -> 0x0153 }
            boolean r4 = r0.equals(r4)     // Catch:{ all -> 0x0153 }
            r6 = 0
            if (r4 == 0) goto L_0x0059
            r0 = 29
            java.lang.String r0 = r1.extractMetadata(r0)     // Catch:{ all -> 0x0153 }
            r4 = 30
            java.lang.String r4 = r1.extractMetadata(r4)     // Catch:{ all -> 0x0153 }
            r5 = 31
            java.lang.String r5 = r1.extractMetadata(r5)     // Catch:{ all -> 0x0153 }
        ...
        L_0x0078:
            ...
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r7 = r13.mAttributes     // Catch:{ all -> 0x0153 }
            r7 = r7[r5]     // Catch:{ all -> 0x0153 }
            java.lang.String r8 = "ImageWidth"
            int r9 = java.lang.Integer.parseInt(r6)     // Catch:{ all -> 0x0153 }
            java.nio.ByteOrder r10 = r13.mExifByteOrder     // Catch:{ all -> 0x0153 }
            io.dcloud.common.util.ExifInterface$ExifAttribute r9 = io.dcloud.common.util.ExifInterface.ExifAttribute.createUShort((int) r9, (java.nio.ByteOrder) r10)     // Catch:{ all -> 0x0153 }
            r7.put(r8, r9)     // Catch:{ all -> 0x0153 }
        L_0x008e:
            if (r4 == 0) goto L_0x00a3
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r7 = r13.mAttributes     // Catch:{ all -> 0x0153 }
            r7 = r7[r5]     // Catch:{ all -> 0x0153 }
            java.lang.String r8 = "ImageLength"
            int r9 = java.lang.Integer.parseInt(r4)     // Catch:{ all -> 0x0153 }
            java.nio.ByteOrder r10 = r13.mExifByteOrder     // Catch:{ all -> 0x0153 }
            io.dcloud.common.util.ExifInterface$ExifAttribute r9 = io.dcloud.common.util.ExifInterface.ExifAttribute.createUShort((int) r9, (java.nio.ByteOrder) r10)     // Catch:{ all -> 0x0153 }
            r7.put(r8, r9)     // Catch:{ all -> 0x0153 }
        L_0x00a3:
            ...
            r8 = 1
            int r9 = java.lang.Integer.parseInt(r0)     // Catch:{ all -> 0x0153 }
            r10 = 90
        ...
        L_0x00bd:
            r8 = 6
        L_0x00be:
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r9 = r13.mAttributes     // Catch:{ all -> 0x0153 }
            r9 = r9[r5]     // Catch:{ all -> 0x0153 }
            java.lang.String r10 = "Orientation"
            java.nio.ByteOrder r11 = r13.mExifByteOrder     // Catch:{ all -> 0x0153 }
            io.dcloud.common.util.ExifInterface$ExifAttribute r8 = io.dcloud.common.util.ExifInterface.ExifAttribute.createUShort((int) r8, (java.nio.ByteOrder) r11)     // Catch:{ all -> 0x0153 }
            r9.put(r10, r8)     // Catch:{ all -> 0x0153 }
        L_0x00cd:
            if (r2 == 0) goto L_0x0120
            if (r3 == 0) goto L_0x0120
            int r2 = java.lang.Integer.parseInt(r2)     // Catch:{ all -> 0x0153 }
            int r3 = java.lang.Integer.parseInt(r3)     // Catch:{ all -> 0x0153 }
            if (r3 <= r7) goto L_0x0118
            long r8 = (long) r2     // Catch:{ all -> 0x0153 }
            r14.seek(r8)     // Catch:{ all -> 0x0153 }
            byte[] r8 = new byte[r7]     // Catch:{ all -> 0x0153 }
            int r9 = r14.read(r8)     // Catch:{ all -> 0x0153 }
            if (r9 != r7) goto L_0x0110
            int r2 = r2 + r7
            int r3 = r3 + -6
            byte[] r7 = IDENTIFIER_EXIF_APP1     // Catch:{ all -> 0x0153 }
            boolean r7 = java.util.Arrays.equals(r8, r7)     // Catch:{ all -> 0x0153 }
            if (r7 == 0) goto L_0x0108
            byte[] r7 = new byte[r3]     // Catch:{ all -> 0x0153 }
            int r14 = r14.read(r7)     // Catch:{ all -> 0x0153 }
            if (r14 != r3) goto L_0x0100
            r13.mOffsetToExifData = r2     // Catch:{ all -> 0x0153 }
            r13.readExifSegment(r7, r5)     // Catch:{ all -> 0x0153 }
            goto L_0x0120
        L_0x0100:
            java.io.IOException r14 = new java.io.IOException     // Catch:{ all -> 0x0153 }
            java.lang.String r0 = "Can't read exif"
            r14.<init>(r0)     // Catch:{ all -> 0x0153 }
        ...
        L_0x0118:
            ...
            throw r14     // Catch:{ all -> 0x0153 }
        L_0x0120:
            boolean r14 = DEBUG     // Catch:{ all -> 0x0153 }
            ...
            r2.append(r3)     // Catch:{ all -> 0x0153 }
            r2.append(r6)     // Catch:{ all -> 0x0153 }
            ...
            java.lang.String r0 = r2.toString()     // Catch:{ all -> 0x0153 }
            android.util.Log.d(r14, r0)     // Catch:{ all -> 0x0153 }
        L_0x014b:
            r1.release()
            return
        L_0x014f:
        ...
        L_0x0159:
            goto L_0x0158
        */
        throw new UnsupportedOperationException("Method not decompiled: io.dcloud.common.util.ExifInterface.getHeifAttributes(io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void getJpegAttributes(io.dcloud.common.util.ExifInterface.ByteOrderedDataInputStream r22, int r23, int r24) throws java.io.IOException {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
        ...
        L_0x00ba:
            ...
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r8 = r0.mAttributes
            r8 = r8[r2]
            int r9 = r22.readUnsignedShort()
            long r12 = (long) r9
            java.nio.ByteOrder r9 = r0.mExifByteOrder
            io.dcloud.common.util.ExifInterface$ExifAttribute r9 = io.dcloud.common.util.ExifInterface.ExifAttribute.createULong((long) r12, (java.nio.ByteOrder) r9)
        ...
        L_0x00f3:
            ...
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r12 = r0.mAttributes
            r8 = r12[r8]
            java.lang.String r12 = new java.lang.String
            java.nio.charset.Charset r13 = ASCII
            r12.<init>(r9, r13)
            io.dcloud.common.util.ExifInterface$ExifAttribute r9 = io.dcloud.common.util.ExifInterface.ExifAttribute.createString(r12)
            r8.put(r11, r9)
        L_0x0115:
            r11 = 0
        L_0x0116:
        ...
        L_0x0121:
            ...
            io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream r6 = new io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream
            r6.<init>((byte[]) r8)
        ...
        L_0x0147:
            ...
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r13 = r0.mAttributes
            r13 = r13[r3]
            io.dcloud.common.util.ExifInterface$ExifAttribute r15 = new io.dcloud.common.util.ExifInterface$ExifAttribute
            int r14 = r9.length
            r20 = r4
            long r3 = (long) r6
            r6 = 1
    ...
    private static android.util.Pair<java.lang.Integer, java.lang.Integer> guessDataFormat(java.lang.String r12) {
        ...
        L_0x015d:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: io.dcloud.common.util.ExifInterface.guessDataFormat(java.lang.String):android.util.Pair");
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:57:0x008e A[Catch:{ all -> 0x0087 }] */
    ...
    private boolean isHeifFormat(byte[] r15) throws java.io.IOException {
        /*
            ...
            r0 = 0
            r1 = 0
            io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream r2 = new io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream     // Catch:{ Exception -> 0x0089 }
            r2.<init>((byte[]) r15)     // Catch:{ Exception -> 0x0089 }
            int r1 = r2.readInt()     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            long r3 = (long) r1     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            r1 = 4
            byte[] r5 = new byte[r1]     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            r2.read(r5)     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            byte[] r6 = HEIF_TYPE_FTYP     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            boolean r5 = java.util.Arrays.equals(r5, r6)     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
        ...
        L_0x0034:
            r5 = r7
        L_0x0035:
            int r11 = r15.length     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            long r11 = (long) r11     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            int r13 = (r3 > r11 ? 1 : (r3 == r11 ? 0 : -1))
            if (r13 <= 0) goto L_0x003d
            int r15 = r15.length     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            long r3 = (long) r15
        L_0x003d:
            long r3 = r3 - r5
            ...
            return r0
        L_0x0046:
            byte[] r15 = new byte[r1]     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            r5 = 0
            r7 = 0
            r8 = 0
        L_0x004c:
            ...
            int r11 = r2.read(r15)     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
        ...
        L_0x005e:
            ...
            goto L_0x007f
        L_0x0063:
            byte[] r11 = HEIF_BRAND_MIF1     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            boolean r11 = java.util.Arrays.equals(r15, r11)     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            r12 = 1
            if (r11 == 0) goto L_0x006e
            r7 = 1
            goto L_0x0077
        L_0x006e:
            byte[] r11 = HEIF_BRAND_HEIC     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
            boolean r11 = java.util.Arrays.equals(r15, r11)     // Catch:{ Exception -> 0x0084, all -> 0x0081 }
        ...
        L_0x0089:
            r15 = move-exception
        L_0x008a:
            boolean r2 = DEBUG     // Catch:{ all -> 0x0087 }
            if (r2 == 0) goto L_0x0095
            java.lang.String r2 = "ExifInterface"
            java.lang.String r3 = "Exception parsing HEIF file type box."
            android.util.Log.d(r2, r3, r15)     // Catch:{ all -> 0x0087 }
        L_0x0095:
        ...
        L_0x00a3:
            goto L_0x00a2
        */
        throw new UnsupportedOperationException("Method not decompiled: io.dcloud.common.util.ExifInterface.isHeifFormat(byte[]):boolean");
    }
    ...
    private boolean isOrfFormat(byte[] r4) throws java.io.IOException {
        /*
            ...
            r0 = 0
            r1 = 0
            io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream r2 = new io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream     // Catch:{ Exception -> 0x002d, all -> 0x0026 }
        ...
        L_0x0033:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.dcloud.common.util.ExifInterface.isOrfFormat(byte[]):boolean");
    }
    ...
    private boolean isRw2Format(byte[] r4) throws java.io.IOException {
        /*
            ...
            r0 = 0
            r1 = 0
            io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream r2 = new io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream     // Catch:{ Exception -> 0x0029, all -> 0x0022 }
        ...
        L_0x002f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.dcloud.common.util.ExifInterface.isRw2Format(byte[]):boolean");
    }
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(6:11|(7:13|14|(2:16|17)|19|20|21|(3:25|(1:27)|28))|(5:30|31|(2:34|32)|41|35)|36|37|38) */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0054, code lost:
        if (com.taobao.weex.el.parse.Operators.SUB.equals(r1) != false) goto L_0x0056;
     */
    ...
    private static java.lang.Long parseDateTime(java.lang.String r10, java.lang.String r11, java.lang.String r12) {
        ...
        L_0x008f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.dcloud.common.util.ExifInterface.parseDateTime(java.lang.String, java.lang.String, java.lang.String):java.lang.Long");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void readImageFileDirectory(io.dcloud.common.util.ExifInterface.ByteOrderedDataInputStream r30, int r31) throws java.io.IOException {
        /*
            r29 = this;
            r0 = r29
            r1 = r30
        ...
        L_0x0047:
            ...
            r18 = 4
            long r9 = r9 + r18
            java.util.HashMap<java.lang.Integer, io.dcloud.common.util.ExifInterface$ExifTag>[] r20 = sExifTagMapsForReading
            r12 = r20[r2]
            java.lang.Integer r4 = java.lang.Integer.valueOf(r13)
            java.lang.Object r4 = r12.get(r4)
            io.dcloud.common.util.ExifInterface$ExifTag r4 = (io.dcloud.common.util.ExifInterface.ExifTag) r4
            boolean r12 = DEBUG
            r11 = 3
        ...
        L_0x0187:
            ...
            r14 = 6
            io.dcloud.common.util.ExifInterface$ExifAttribute r3 = io.dcloud.common.util.ExifInterface.ExifAttribute.createUShort((int) r14, (java.nio.ByteOrder) r3)
            int r14 = r0.mOrfThumbnailOffset
            r19 = r15
            long r14 = (long) r14
            java.nio.ByteOrder r2 = r0.mExifByteOrder
            io.dcloud.common.util.ExifInterface$ExifAttribute r2 = io.dcloud.common.util.ExifInterface.ExifAttribute.createULong((long) r14, (java.nio.ByteOrder) r2)
            int r14 = r0.mOrfThumbnailLength
            long r14 = (long) r14
            r24 = r4
            java.nio.ByteOrder r4 = r0.mExifByteOrder
            io.dcloud.common.util.ExifInterface$ExifAttribute r4 = io.dcloud.common.util.ExifInterface.ExifAttribute.createULong((long) r14, (java.nio.ByteOrder) r4)
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r14 = r0.mAttributes
            r15 = 4
            r14 = r14[r15]
            r14.put(r7, r3)
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r3 = r0.mAttributes
            r3 = r3[r15]
            java.lang.String r14 = "JPEGInterchangeFormat"
            r3.put(r14, r2)
            java.util.HashMap<java.lang.String, io.dcloud.common.util.ExifInterface$ExifAttribute>[] r2 = r0.mAttributes
            r2 = r2[r15]
        ...
        L_0x02e5:
            ...
            byte[] r4 = new byte[r4]
            r1.readFully(r4)
            io.dcloud.common.util.ExifInterface$ExifAttribute r5 = new io.dcloud.common.util.ExifInterface$ExifAttribute
            r12 = r4
            long r3 = (long) r2
            r2 = r19
            r15 = r5
    ...
    private void saveWebpAttributes(java.io.InputStream r21, java.io.OutputStream r22) throws java.io.IOException {
        /*
            ...
            android.util.Log.d(r4, r3)
        L_0x002d:
            io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream r3 = new io.dcloud.common.util.ExifInterface$ByteOrderedDataInputStream
            java.nio.ByteOrder r4 = java.nio.ByteOrder.LITTLE_ENDIAN
            r3.<init>(r0, r4)
            io.dcloud.common.util.ExifInterface$ByteOrderedDataOutputStream r5 = new io.dcloud.common.util.ExifInterface$ByteOrderedDataOutputStream
            r5.<init>(r2, r4)
            ...
            r3.skipBytes(r7)
            r7 = 0
            java.io.ByteArrayOutputStream r9 = new java.io.ByteArrayOutputStream     // Catch:{ Exception -> 0x01f3 }
            r9.<init>()     // Catch:{ Exception -> 0x01f3 }
            io.dcloud.common.util.ExifInterface$ByteOrderedDataOutputStream r10 = new io.dcloud.common.util.ExifInterface$ByteOrderedDataOutputStream     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r10.<init>(r9, r4)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            int r4 = r1.mOffsetToExifData     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            ...
            int r4 = r4 - r8
            int r4 = r4 - r8
            copy(r3, r10, r4)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r3.skipBytes(r8)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            int r0 = r3.readInt()     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r3.skipBytes(r0)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r1.writeExifSegment(r10)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            goto L_0x01cd
        L_0x006f:
            ...
            byte[] r4 = WEBP_CHUNK_TYPE_VP8X     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
        ...
        L_0x00a2:
            ...
            r10.writeInt(r2)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r10.write(r6)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            if (r12 == 0) goto L_0x00c8
            byte[] r2 = WEBP_CHUNK_TYPE_ANIM     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r1.copyChunksUpToGivenChunkType(r3, r10, r2, r7)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
        L_0x00b2:
            byte[] r2 = new byte[r8]     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r0.read(r2)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            byte[] r4 = WEBP_CHUNK_TYPE_ANMF     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            boolean r4 = java.util.Arrays.equals(r2, r4)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            if (r4 != 0) goto L_0x00c4
            r1.writeExifSegment(r10)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            goto L_0x01cd
        L_0x00c4:
            r1.copyWebPChunk(r3, r10, r2)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            goto L_0x00b2
        L_0x00c8:
            byte[] r0 = WEBP_CHUNK_TYPE_VP8     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            byte[] r2 = WEBP_CHUNK_TYPE_VP8L     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r1.copyChunksUpToGivenChunkType(r3, r10, r0, r2)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r1.writeExifSegment(r10)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            goto L_0x01cd
        L_0x00d4:
            byte[] r0 = WEBP_CHUNK_TYPE_VP8     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            ...
            byte[] r6 = WEBP_CHUNK_TYPE_VP8L     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
        ...
        L_0x00f0:
            ...
            byte[] r11 = WEBP_VP8_SIGNATURE     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
        ...
        L_0x0125:
            byte[] r11 = WEBP_CHUNK_TYPE_VP8L     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
        ...
        L_0x0159:
            r10.write(r4)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r4 = 10
            r10.writeInt(r4)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            ...
            byte r8 = (byte) r14     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r12 = 7
            r4[r12] = r8     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            int r8 = r14 >> 8
            byte r8 = (byte) r8     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            ...
            r10.writeInt(r6)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            ...
            byte[] r0 = WEBP_VP8_SIGNATURE     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r10.write(r0)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r10.writeInt(r11)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            goto L_0x01c7
        L_0x01b7:
            byte[] r0 = WEBP_CHUNK_TYPE_VP8L     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            boolean r0 = java.util.Arrays.equals(r2, r0)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            ...
            r10.writeInt(r11)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
        L_0x01c7:
            copy(r3, r10, r7)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            r1.writeExifSegment(r10)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
        L_0x01cd:
            copy(r3, r10)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            int r0 = r9.size()     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            byte[] r2 = WEBP_SIGNATURE_2     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            int r3 = r2.length     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
            int r0 = r0 + r3
            r5.writeInt(r0)     // Catch:{ Exception -> 0x01f0, all -> 0x01ed }
        ...
        L_0x01f3:
            r0 = move-exception
        L_0x01f4:
            java.io.IOException r2 = new java.io.IOException     // Catch:{ all -> 0x01fc }
            java.lang.String r3 = "Failed to save WebP file"
            r2.<init>(r3, r0)     // Catch:{ all -> 0x01fc }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v2, resolved type: java.io.FileDescriptor} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v4, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v0, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v4, resolved type: java.io.InputStream} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v1, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v9, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v4, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v4, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v5, resolved type: java.io.InputStream} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v7, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v12, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v14, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v13, resolved type: java.io.FileDescriptor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v21, resolved type: java.io.FileDescriptor} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x0060 A[SYNTHETIC, Splitter:B:36:0x0060] */
    /* JADX WARNING: Removed duplicated region for block: B:53:0x0099 A[Catch:{ Exception -> 0x00a2, all -> 0x009f }] */
    ...
    public byte[] getThumbnailBytes() {
        ...
        L_0x0008:
            ...
            return r1
        L_0x000d:
            android.content.res.AssetManager$AssetInputStream r1 = r11.mAssetInputStream     // Catch:{ Exception -> 0x00aa, all -> 0x00a7 }
            if (r1 == 0) goto L_0x002c
            boolean r3 = r1.markSupported()     // Catch:{ Exception -> 0x0028, all -> 0x0025 }
            if (r3 == 0) goto L_0x001c
            r1.reset()     // Catch:{ Exception -> 0x0028, all -> 0x0025 }
        L_0x001a:
            r3 = r2
            goto L_0x005e
        L_0x001c:
            java.lang.String r3 = "Cannot read thumbnail from inputstream without mark/reset support"
            android.util.Log.d(r0, r3)     // Catch:{ Exception -> 0x0028, all -> 0x0025 }
            closeQuietly(r1)
            return r2
        L_0x0025:
            r0 = move-exception
        ...
        L_0x0028:
            ...
            goto L_0x00af
        L_0x002c:
            java.lang.String r1 = r11.mFilename     // Catch:{ Exception -> 0x00aa, all -> 0x00a7 }
            if (r1 == 0) goto L_0x0038
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch:{ Exception -> 0x00aa, all -> 0x00a7 }
            java.lang.String r3 = r11.mFilename     // Catch:{ Exception -> 0x00aa, all -> 0x00a7 }
            r1.<init>(r3)     // Catch:{ Exception -> 0x00aa, all -> 0x00a7 }
            goto L_0x001a
        L_0x0038:
            int r1 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x00aa, all -> 0x00a7 }
            r3 = 21
            if (r1 < r3) goto L_0x005c
            java.io.FileDescriptor r1 = r11.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00aa, all -> 0x00a7 }
            java.io.FileDescriptor r1 = android.system.Os.dup(r1)     // Catch:{ Exception -> 0x00aa, all -> 0x00a7 }
            r3 = 0
            int r5 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0057, all -> 0x0054 }
            android.system.Os.lseek(r1, r3, r5)     // Catch:{ Exception -> 0x0057, all -> 0x0054 }
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0057, all -> 0x0054 }
            r3.<init>(r1)     // Catch:{ Exception -> 0x0057, all -> 0x0054 }
            r10 = r3
            r3 = r1
            r1 = r10
            goto L_0x005e
        ...
        L_0x005e:
            ...
            int r4 = r11.mThumbnailOffset     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            int r5 = r11.mOffsetToExifData     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            int r4 = r4 + r5
            long r4 = (long) r4     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            long r4 = r1.skip(r4)     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            int r6 = r11.mThumbnailOffset     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            int r7 = r11.mOffsetToExifData     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            int r6 = r6 + r7
            long r6 = (long) r6
            java.lang.String r8 = "Corrupted image"
            int r9 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r9 != 0) goto L_0x0093
            int r4 = r11.mThumbnailLength     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            byte[] r4 = new byte[r4]     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            int r5 = r1.read(r4)     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            int r6 = r11.mThumbnailLength     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            if (r5 != r6) goto L_0x008d
            r11.mThumbnailBytes = r4     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            closeQuietly(r1)
        ...
        L_0x008c:
            return r4
        L_0x008d:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            r4.<init>(r8)     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            throw r4     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
        L_0x0093:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            r4.<init>(r8)     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            throw r4     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
        L_0x0099:
            java.io.FileNotFoundException r4 = new java.io.FileNotFoundException     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            r4.<init>()     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
            throw r4     // Catch:{ Exception -> 0x00a2, all -> 0x009f }
        L_0x009f:
            r0 = move-exception
            r2 = r3
        ...
        L_0x00af:
            ...
            android.util.Log.d(r0, r5, r3)     // Catch:{ all -> 0x00bd }
            closeQuietly(r1)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:67:0x00db, code lost:
        if (android.os.Build.VERSION.SDK_INT >= 21) goto L_0x00dd;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:68:0x00dd, code lost:
        ...
        r4 = new java.io.FileOutputStream(r14.mSeekableFileDescriptor);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:69:0x00ec, code lost:
        r4 = new java.io.FileOutputStream(r14.mFilename);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:93:0x013f, code lost:
        r2.delete();
     */
    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Removed duplicated region for block: B:57:0x00c7 A[ExcHandler: all (th java.lang.Throwable), Splitter:B:22:0x005c] */
    /* JADX WARNING: Removed duplicated region for block: B:66:0x00d9 A[Catch:{ Exception -> 0x0108, all -> 0x0105 }] */
    /* JADX WARNING: Removed duplicated region for block: B:69:0x00ec A[Catch:{ Exception -> 0x0108, all -> 0x0105 }] */
    ...
    public void saveAttributes() throws java.io.IOException {
        ...
        L_0x0017:
            ...
            java.io.File r2 = java.io.File.createTempFile(r2, r3)     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            java.lang.String r3 = r14.mFilename     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            r4 = 0
            r6 = 21
            if (r3 == 0) goto L_0x0039
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            java.lang.String r7 = r14.mFilename     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            r3.<init>(r7)     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            goto L_0x004d
        L_0x0039:
            int r3 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            if (r3 < r6) goto L_0x004c
            java.io.FileDescriptor r3 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            android.system.Os.lseek(r3, r4, r7)     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            java.io.FileDescriptor r7 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            r3.<init>(r7)     // Catch:{ Exception -> 0x014e, all -> 0x014b }
            goto L_0x004d
        L_0x004c:
            r3 = r1
        L_0x004d:
            java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0149 }
            r7.<init>(r2)     // Catch:{ Exception -> 0x0149 }
            copy(r3, r7)     // Catch:{ Exception -> 0x0146, all -> 0x0143 }
            closeQuietly(r3)
            closeQuietly(r7)
            r3 = 0
            java.io.FileInputStream r7 = new java.io.FileInputStream     // Catch:{ Exception -> 0x00cb, all -> 0x00c7 }
            r7.<init>(r2)     // Catch:{ Exception -> 0x00cb, all -> 0x00c7 }
            java.lang.String r8 = r14.mFilename     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            if (r8 == 0) goto L_0x006d
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            java.lang.String r9 = r14.mFilename     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            r8.<init>(r9)     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            goto L_0x0081
        L_0x006d:
            int r8 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            if (r8 < r6) goto L_0x0080
            java.io.FileDescriptor r8 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            int r9 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            android.system.Os.lseek(r8, r4, r9)     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            java.io.FileDescriptor r9 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            r8.<init>(r9)     // Catch:{ Exception -> 0x00c3, all -> 0x00c7 }
            goto L_0x0081
        L_0x0080:
            r8 = r1
        L_0x0081:
            java.io.BufferedInputStream r9 = new java.io.BufferedInputStream     // Catch:{ Exception -> 0x00bd, all -> 0x00c7 }
            r9.<init>(r7)     // Catch:{ Exception -> 0x00bd, all -> 0x00c7 }
            java.io.BufferedOutputStream r10 = new java.io.BufferedOutputStream     // Catch:{ Exception -> 0x00b7, all -> 0x00b4 }
            r10.<init>(r8)     // Catch:{ Exception -> 0x00b7, all -> 0x00b4 }
        ...
        L_0x00d0:
            ...
            java.lang.String r7 = r14.mFilename     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            if (r7 != 0) goto L_0x00ec
            int r7 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            if (r7 < r6) goto L_0x00f4
            java.io.FileDescriptor r6 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            android.system.Os.lseek(r6, r4, r7)     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            java.io.FileOutputStream r4 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            java.io.FileDescriptor r5 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            r4.<init>(r5)     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            goto L_0x00f3
        L_0x00ec:
            java.io.FileOutputStream r4 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            java.lang.String r5 = r14.mFilename     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            r4.<init>(r5)     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
        L_0x00f3:
            r1 = r4
        L_0x00f4:
            copy(r11, r1)     // Catch:{ Exception -> 0x0108, all -> 0x0105 }
            closeQuietly(r11)     // Catch:{ all -> 0x0133 }
            closeQuietly(r1)     // Catch:{ all -> 0x0133 }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x0133 }
            java.lang.String r1 = "Failed to save new file"
            r0.<init>(r1, r8)     // Catch:{ all -> 0x0133 }
        ...
        L_0x010d:
            r3 = move-exception
        L_0x010e:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ all -> 0x0129 }
            ...
            java.lang.String r6 = r2.getAbsolutePath()     // Catch:{ all -> 0x0129 }
            r5.append(r6)     // Catch:{ all -> 0x0129 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0129 }
            r4.<init>(r5, r3)     // Catch:{ all -> 0x0129 }
            throw r4     // Catch:{ all -> 0x0129 }
        L_0x0129:
            r3 = move-exception
            r0 = r3
            r3 = 1
        L_0x012c:
            closeQuietly(r7)     // Catch:{ all -> 0x0133 }
            closeQuietly(r1)     // Catch:{ all -> 0x0133 }
            throw r0     // Catch:{ all -> 0x0133 }
        L_0x0133:
            r0 = move-exception
        ...
        L_0x0150:
            ...
            r2.<init>(r4, r0)     // Catch:{ all -> 0x0158 }
    ...
    public ExifInterface(java.io.FileDescriptor r6) throws java.io.IOException {
        /*
            r5 = this;
            r5.<init>()
            io.dcloud.common.util.ExifInterface$ExifTag[][] r0 = EXIF_TAGS
            int r1 = r0.length
        ...
        L_0x005f:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: io.dcloud.common.util.ExifInterface.<init>(java.io.FileDescriptor):void");
    }
    ...
    public void setAttribute(String str, String str2) {
        ...
        if ((TAG_DATETIME.equals(str4) || TAG_DATETIME_ORIGINAL.equals(str4) || TAG_DATETIME_DIGITIZED.equals(str4)) && str5 != null) {
            ...
            if (str2.length() != 19 || (!find && !find2)) {
                ...
                str5 = str5.replaceAll(Operators.SUB, ":");
            }
        }
